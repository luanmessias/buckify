interface Resources {
  "en": {
    ...
    "Category": {
      ...
      "category_name_mismatch": "Category name does not match",
      "category_updated": "Category updated successfully",
      "currency_symbol": "€",
      "danger_zone": "Danger Zone",
      "danger_zone_description": "Permanently delete this category and manage its transactions.",
      "delete_all_transactions": "Delete all transactions",
      "delete_category": "Delete Category",
      "delete_category_confirmation": "Delete \"{name}\"?",
      "delete_category_warning": "This action cannot be undone. This category will be permanently removed.",
      ...
      "move_to": "Move to",
      "move_transactions": "Move transactions to another category",
      ...
      "select_move_category": "Please select a category to move transactions to",
      ...
      "used_of_budget": "Used",
      "what_to_do_transactions": "What to do with existing transactions?"
    },
    "Common": {
      "close": "Close",
    ...
    "NotFound": {
      "button": "Return Home",
      "description": "It seems you've ventured into the void.",
    ...
    "UserSettings": {
      ...
      "account_delete_generic_error": "An error occurred while deleting",
